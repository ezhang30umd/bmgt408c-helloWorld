...
with app.app_context():
    ...
    students = [
        {'student_id': '1', 'first_name': 'Robert', 'last_name':'Smith', 'email' : 'rsmith@terpmail.umd.edu', 'major_id':3,
            'birth_date': dt.datetime(2005, 6, 1), 'is_honors':1},
        {'student_id': '2', 'first_name': 'Leo', 'last_name': 'Van Munching', 'email':'lvanmunching@terpmail.umd.edu','major_id':6,
